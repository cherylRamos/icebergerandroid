...
public class drinksFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_drinks, container, false);
        final CartSession cartSess = new CartSession();
        Double total_cost = 0.00;
        TextView myBurgerContentTotal;
        new JSONGrabber("method=getinventory&category=5") {
            ...
            protected void onPostExecute(JSONObject jsonObject) {
                ...
                try {
                    ...
                    final LinearLayout list = view.findViewById(R.id.drinks_list);
                    list.removeAllViews();
...
//                          itemcost = 4.00;
                        ...
                        if (item.getInt("id") == 25){
                           // itemcost = 3.00;
                            pic.setImageDrawable(view.getContext().getDrawable(R.drawable.icet));
                            pic.setScaleType(ImageView.ScaleType.FIT_CENTER);
                            pic.setAdjustViewBounds(true);
                            pic.setMaxWidth(10);
                            desc.setText("               "+(String)item.get("name")+"          $ "+(String)item.get("cost")+"         ");
...
//                            itemcost = 6.00;
                            pic.setImageDrawable(view.getContext().getDrawable(R.drawable.milk));
                            pic.setScaleType(ImageView.ScaleType.FIT_CENTER);
                            pic.setAdjustViewBounds(true);
                            pic.setMaxWidth(10);
                            desc.setText("               "+(String)item.get("name")+"          $ "+(String)item.get("cost")+"         ");
...
//                            itemcost = 2.00;
                            pic.setImageDrawable(view.getContext().getDrawable(R.drawable.sprite));
                            pic.setScaleType(ImageView.ScaleType.FIT_CENTER);
                            pic.setAdjustViewBounds(true);
                            pic.setMaxWidth(10);
                            desc.setText("               "+(String)item.get("name")+"          $ "+(String)item.get("cost")+"         ");
...
//                            itemcost = 6.00;
                            pic.setImageDrawable(view.getContext().getDrawable(R.drawable.cola));
                            pic.setScaleType(ImageView.ScaleType.FIT_CENTER);
                            pic.setAdjustViewBounds(true);
                            pic.setMaxWidth(10);
                            desc.setText("               "+(String)item.get("name")+"          $ "+(String)item.get("cost")+"         ");
...
//                            desc.setText((String)item.get("name")+"  $"+(String)item.get("cost"));
                        ...
                        if (item.getInt("id") == 30){
                           // itemcost = 4.00;
                            pic.setImageDrawable(view.getContext().getDrawable(R.drawable.fanta));
                            pic.setScaleType(ImageView.ScaleType.FIT_CENTER);
                            pic.setAdjustViewBounds(true);
                            pic.setMaxWidth(10);
                            desc.setText("               "+(String)item.get("name")+"          $ "+(String)item.get("cost")+"         ");
