...
public class BunFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       final View view = inflater.inflate(R.layout.fragment_bun, container, false);
        ...
        new JSONGrabber("method=getinventory&category=1") {
            ...
            protected void onPostExecute(JSONObject jsonObject) {
                ...
                try {
                    ...
                    final LinearLayout list = view.findViewById(R.id.buns_list);
                    list.removeAllViews();
...
//start
                        ...
                        if (item.getInt("id") == 1){
                            ...
                            pic.setImageDrawable(view.getContext().getDrawable(R.drawable.doughnut));
...
//                          itemcost = 4.00;
                        ...
                        if (item.getInt("id") == 2){
                            // itemcost = 3.00;
                            pic.setImageDrawable(view.getContext().getDrawable(R.drawable.waffle));
                            pic.setScaleType(ImageView.ScaleType.FIT_CENTER);
                            pic.setAdjustViewBounds(true);
                            pic.setMaxWidth(10);
                            desc.setText("               "+(String)item.get("name")+"          $ "+(String)item.get("cost")+"         ");
                        ...
                        if (item.getInt("id") == 4){
//                            itemcost = 6.00;
                            pic.setImageDrawable(view.getContext().getDrawable(R.drawable.brioche));
                            pic.setScaleType(ImageView.ScaleType.FIT_CENTER);
                            pic.setAdjustViewBounds(true);
                            pic.setMaxWidth(10);
                        ...
                        if (item.getInt("id") == 5){
//                            itemcost = 2.00;
                            pic.setImageDrawable(view.getContext().getDrawable(R.drawable.cookie));
                            pic.setScaleType(ImageView.ScaleType.FIT_CENTER);
                            pic.setAdjustViewBounds(true);
                            pic.setMaxWidth(10);
                            desc.setText("               "+(String)item.get("name")+"          $ "+(String)item.get("cost")+"         ");
...
//                            desc.setText((String)item.get("name")+"  $"+(String)item.get("cost"));
                        ...
                        if (item.getInt("id") == 39){
//                            itemcost = 6.00;
                            pic.setImageDrawable(view.getContext().getDrawable(R.drawable.cinnabon));
                            pic.setScaleType(ImageView.ScaleType.FIT_CENTER);
                            pic.setAdjustViewBounds(true);
                            pic.setMaxWidth(10);
                            desc.setText("               "+(String)item.get("name")+"          $ "+(String)item.get("cost")+"         ");
                        ...
                        if (item.getInt("id") == 43){
                            // itemcost = 4.00;
                            pic.setImageDrawable(view.getContext().getDrawable(R.drawable.kitkat));
                            pic.setScaleType(ImageView.ScaleType.FIT_CENTER);
                            pic.setAdjustViewBounds(true);
                            pic.setMaxWidth(10);
                            desc.setText("               "+(String)item.get("name")+"          $ "+(String)item.get("cost")+"         ");
...
//                            desc.setText((String)item.get("name")+"  $"+(String)item.get("cost"));
                        ...
                        if (item.getInt("id") == 44){
//                            itemcost = 2.00;
                            pic.setImageDrawable(view.getContext().getDrawable(R.drawable.wafer));
                            pic.setScaleType(ImageView.ScaleType.FIT_CENTER);
                            pic.setAdjustViewBounds(true);
                            pic.setMaxWidth(10);
                            desc.setText("               "+(String)item.get("name")+"          $ "+(String)item.get("cost")+"         ");
                        ...
                        if (item.getInt("id") == 45){
//                            itemcost = 6.00;
                            pic.setImageDrawable(view.getContext().getDrawable(R.drawable.pancake));
                            pic.setScaleType(ImageView.ScaleType.FIT_CENTER);
                            pic.setAdjustViewBounds(true);
                            pic.setMaxWidth(10);
                            desc.setText("               "+(String)item.get("name")+"          $ "+(String)item.get("cost")+"         ");
