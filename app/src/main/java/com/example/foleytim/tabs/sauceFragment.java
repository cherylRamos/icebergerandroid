        ...
        new JSONGrabber("method=getinventory&category=3") {
            ...
            protected void onPostExecute(JSONObject jsonObject) {
                ...
                try {
                    ...
                    final LinearLayout list = view.findViewById(R.id.sauce_list);
                    list.removeAllViews();
...
//start
                        ...
                        if (item.getInt("id") == 11){

                            pic.setImageDrawable(view.getContext().getDrawable(R.drawable.chocsauce));
...
//                            desc.setText((String)item.get("name")+"  $"+(String)item.get("cost"));
                        ...
                        if (item.getInt("id") == 12){
                            // itemcost = 3.00;
                            pic.setImageDrawable(view.getContext().getDrawable(R.drawable.nutella));
                            pic.setScaleType(ImageView.ScaleType.FIT_CENTER);
                            pic.setAdjustViewBounds(true);
                            pic.setMaxWidth(10);
                            desc.setText("               "+(String)item.get("name")+"          $ "+(String)item.get("cost")+"         ");
...
//                            desc.setText((String)item.get("name")+"  $"+(String)item.get("cost"));
                        ...
                        if (item.getInt("id") == 13){
//                            itemcost = 6.00;
                            pic.setImageDrawable(view.getContext().getDrawable(R.drawable.caramel));
                            pic.setScaleType(ImageView.ScaleType.FIT_CENTER);
                            pic.setAdjustViewBounds(true);
                            pic.setMaxWidth(10);
                            desc.setText("               "+(String)item.get("name")+"          $ "+(String)item.get("cost")+"         ");
...
//                            desc.setText((String)item.get("name")+"  $"+(String)item.get("cost"));
                        ...
                        if (item.getInt("id") == 14){
//                            itemcost = 2.00;
                            pic.setImageDrawable(view.getContext().getDrawable(R.drawable.raspberry));
                            pic.setScaleType(ImageView.ScaleType.FIT_CENTER);
                            pic.setAdjustViewBounds(true);
                            pic.setMaxWidth(10);
                            desc.setText("               "+(String)item.get("name")+"          $ "+(String)item.get("cost")+"         ");
...
//                            desc.setText((String)item.get("name")+"  $"+(String)item.get("cost"));
                        ...
                        if (item.getInt("id") == 15){
//                            itemcost = 6.00;
                            pic.setImageDrawable(view.getContext().getDrawable(R.drawable.lemoncurd));
                            pic.setScaleType(ImageView.ScaleType.FIT_CENTER);
                            pic.setAdjustViewBounds(true);
                            pic.setMaxWidth(10);
                            desc.setText("               "+(String)item.get("name")+"          $ "+(String)item.get("cost")+"         ");
...
//                            desc.setText((String)item.get("name")+"  $"+(String)item.get("cost"));
                        ...
                        if (item.getInt("id") == 16){
                            // itemcost = 4.00;
                            pic.setImageDrawable(view.getContext().getDrawable(R.drawable.peanutbsauce));
                            pic.setScaleType(ImageView.ScaleType.FIT_CENTER);
                            pic.setAdjustViewBounds(true);
                            pic.setMaxWidth(10);
                            desc.setText("               "+(String)item.get("name")+"          $ "+(String)item.get("cost")+"         ");
...
//                            desc.setText((String)item.get("name")+"  $"+(String)item.get("cost"));
                        ...
                        if (item.getInt("id") == 17){
//                            itemcost = 6.00;
                            pic.setImageDrawable(view.getContext().getDrawable(R.drawable.creamsauce));
                            pic.setScaleType(ImageView.ScaleType.FIT_CENTER);
                            pic.setAdjustViewBounds(true);
                            pic.setMaxWidth(10);
                            desc.setText("               "+(String)item.get("name")+"          $ "+(String)item.get("cost")+"         ");
...
//                            desc.setText((String)item.get("name")+"  $"+(String)item.get("cost"));
                        ...
                        if (item.getInt("id") == 47){
                            // itemcost = 4.00;
                            pic.setImageDrawable(view.getContext().getDrawable(R.drawable.yoghurt));
                            pic.setScaleType(ImageView.ScaleType.FIT_CENTER);
                            pic.setAdjustViewBounds(true);
                            pic.setMaxWidth(10);
                            desc.setText("               "+(String)item.get("name")+"          $ "+(String)item.get("cost")+"         ");
